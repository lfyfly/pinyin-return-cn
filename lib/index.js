...
class NodePinyin extends Pinyin {
  ...
  convert (hans, options) {
    ...
    if (options.mode === Pinyin.MODE_SURNAME) {
      pys = pys.concat(this.surname_pinyin(hans, options));
      return pys;
    }
...
module.exports.MODE_NORMAL = Pinyin.MODE_NORMAL;
module.exports.MODE_SURNAME = Pinyin.MODE_SURNAME;
module.exports.MODE_PLACENAME = Pinyin.MODE_PLACENAME;
